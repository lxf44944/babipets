...
class Actions(models.Model):
    post = models.OneToOneField('Posts', models.DO_NOTHING, primary_key=True)
...
class Posts(models.Model):
    ...
    post_media_urls = models.CharField(max_length=1000, blank=True, null=True)  # This field type is a guess.
